...
<div class="card">
<div class="card-body">
<form method="post" action="{{route('assignweeks.store')}}" class="form-horizontal" enctype="multipart/form-data">
@csrf
<div class="row g-7">
                ...
                <input type="text" name="assign_week"  class="form-control form-control-solid" placeholder=""/>
                </div>
                <div class="col-md-12 fv-row">
                <label class="form-label">
