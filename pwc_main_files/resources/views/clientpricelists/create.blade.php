...
<div class="card">
<div class="card-body">
<form method="post" action="{{route('clientpricelists.store')}}" class="form-horizontal" enctype="multipart/form-data">
@csrf
<div class="row g-7">
                ...
                <input type="text" name="value"  class="form-control form-control-solid" placeholder=""/>
                </div>
