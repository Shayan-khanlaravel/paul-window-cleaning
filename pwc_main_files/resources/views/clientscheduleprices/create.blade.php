...
<div class="card">
<div class="card-body">
<form method="post" action="{{route('clientscheduleprices.store')}}" class="form-horizontal" enctype="multipart/form-data">
@csrf
<div class="row g-7">
                ...
                <input type="text" name="schedule_id"  class="form-control form-control-solid" placeholder=""/>
                </div>
                <div class="col-md-12 fv-row">
                <label class="form-label">
                <span class="">Price_id</span>
                </label>
                <input type="text" name="price_id"  class="form-control form-control-solid" placeholder=""/>
                </div>
