...
<div class="card">
<div class="card-body">
<form method="post" action="{{route('clienttimes.store')}}" class="form-horizontal" enctype="multipart/form-data">
@csrf
<div class="row g-7">
                ...
                <input type="text" name="start_hour"  class="form-control form-control-solid" placeholder=""/>
                </div>
                <div class="col-md-12 fv-row">
                <label class="form-label">
                <span class="">End_hour</span>
                </label>
                <input type="text" name="end_hour"  class="form-control form-control-solid" placeholder=""/>
                </div>
