...
<div class="card">
<div class="card-body">
<form method="post" action="{{route('cmsservices.store')}}" class="form-horizontal" enctype="multipart/form-data">
@csrf
<div class="row g-7">
                ...
                <input type="text" name="section_two_description"  class="form-control form-control-solid" placeholder=""/>
                </div>
                <div class="col-md-12 fv-row">
                <label class="form-label">
                ...
                <input type="text" name="section_two_image"  class="form-control form-control-solid" placeholder=""/>
                </div>
