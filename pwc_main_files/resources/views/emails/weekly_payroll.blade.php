...
<html>
<head>
    <title>Semi-Monthly Payroll Details</title>
</head>
<body style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
        <h2 style="color: #00ADEE; text-align: center;">Semi-Monthly Payroll Details</h2>

        <p>Hello Accountant,</p>
        <p>Here are the payroll details for <strong>{{ $data['staff_name'] }}</strong> for the period <strong>{{ $data['period_label'] }}</strong>.</p>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            ...
            <tr>
                <td style="padding: 10px; border: 1px solid #ddd; font-weight: bold; background: #f9f9f9;">Pay Period</td>
                <td style="padding: 10px; border: 1px solid #ddd;">{{ $data['period_label'] }}</td>
            </tr>
            <tr>
