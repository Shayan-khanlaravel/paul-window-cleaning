...
<div id="" class="app-content flex-column-fluid">
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="card">
            <div class="card-body">
                <form method="post" id="kt_modal_update_role_form" action="{{ route('settings.update', $setting->id) }}" class="form-horizontal"
                    ...
                    <div class="row g-7">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <textarea class="form-control form-control-solid" rows="3" name="description" placeholder="Type Target Details">{{ $setting->description ?? '' }}</textarea>
                        </div>
                        <div class="col-md-12 fv-row">
                            <label class="form-label">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <input type="text" name="footer_text" class="form-control form-control-solid"
                                placeholder="" value="{{ $setting->footer_text ?? '' }}" />
                        </div>
                        <div class="col-md-12 fv-row">
                            <label class="form-label">
                                <span class="">Facebook
                            ...
                            <input type="text" name="facebook" class="form-control form-control-solid"
                                placeholder="" value="{{ $setting->facebook ?? '' }}" />
                        </div>
                        <div class="col-md-12 fv-row">
                            <label class="form-label">
                                <span class="">Twitter
                            ...
                            <input type="text" name="twitter" class="form-control form-control-solid"
                                placeholder="" value="{{ $setting->twitter ?? '' }}" />
                        </div>
                        <div class="col-md-12 fv-row">
                            <label class="form-label">
                                <span class="">Youtube
                            ...
                            <input type="text" name="youtube" class="form-control form-control-solid"
                                placeholder="" value="{{ $setting->youtube ?? '' }}" />
                        </div>
                        <div class="col-md-12 fv-row">
                            <label class="form-label">
                            ...
                            <input type="text" name="instagram" class="form-control form-control-solid"
                                placeholder="" value="{{ $setting->instagram ?? '' }}" />
                        </div>
                        <div class="col-md-12 fv-row">
                            <label class="form-label">
                            ...
                            <input type="text" name="whatsapp" class="form-control form-control-solid"
                                placeholder="" value="{{ $setting->whatsapp ?? '' }}" />
                        </div>
                        <div class="col-md-12 fv-row">
                            <label class="form-label">
                            ...
                            <input type="text" name="stripe_publishable" class="form-control form-control-solid"
                                placeholder="" value="{{ $setting->stripe_publishable ?? '' }}" />
                        </div>
                        <div class="col-md-12 fv-row">
                            <label class="form-label">
                            ...
                            <input type="text" name="stripe_secret" class="form-control form-control-solid"
                                placeholder="" value="{{ $setting->stripe_secret ?? '' }}" />
                        </div>
                        ...
                        <div class="row mb-8">
                                                ...
                                                <div class="card-footer d-flex justify-content-end py-6 px-9">
                                                    <a href="{{ route('settings.index') }}"class="btn btn-light btn-active-light-primary me-2">Cancel</a>
...
<script>var hostUrl = "assets/";</script>
        ...
        <script src="{{asset('website')}}/assets/js/custom/apps/projects/settings/settings.js"></script>
