...
<div class="row g-7">
                ...
                <input type="text" name="staff_id"  class="form-control form-control-solid" placeholder=""/>
                </div>
                <div class="col-md-12 fv-row">
                <label class="form-label">
                ...
                <input type="text" name="quantity"  class="form-control form-control-solid" placeholder=""/>
                </div>
                <div class="col-md-12 fv-row">
                <label class="form-label">
                ...
                <input type="text" name="status"  class="form-control form-control-solid" placeholder=""/>
                </div>
