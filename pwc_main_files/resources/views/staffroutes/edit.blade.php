...
@section('content')
    ...
    <div id="" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{route('staffroutes.update',$staffroute->id)}}" class="form-horizontal"
                        ...
                        <div class="row g-7">
                            ...
                            <div class="col-md-12 fv-row">
                                ...
                                <input type="text" name="name" required class="form-control form-control-solid"
                                       placeholder="" value="{{$staffroute->name??''}}"/>
                            </div>
                            <div class="col-md-12 fv-row">
                                <label class="form-label">
                            ...
                            <div class="text-center">
                                <a href="{{route('staffroutes.index')}}" id="kt_modal_new_target_cancel"
