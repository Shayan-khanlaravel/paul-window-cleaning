...
@endsection			
@push('js')
	<script src="{{asset('website')}}/assets/js/custom/apps/user-management/permissions/list.js"></script>
	<script src="{{asset('website')}}/assets/js/custom/apps/user-management/permissions/add-permission.js"></script>
	<script src="{{asset('website')}}/assets/js/custom/apps/user-management/permissions/update-permission.js"></script>
