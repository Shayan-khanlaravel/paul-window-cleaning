...
<div class="card">
<div class="card-body">
<form method="post" action="{{route('unavaildays.store')}}" class="form-horizontal" enctype="multipart/form-data">
@csrf
<div class="row g-7">
                ...
                <input type="text" name="day"  class="form-control form-control-solid" placeholder=""/>
                </div>
